...
public class SPManager : MonoBehaviour
{
    ...
    void MatchMessage()
    {
        if (PlayerWon())
        {
            Message.GetComponent<Text>().text = "I will return!";
            End = true;
        }
        else if (MachineWon())
        {
            Message.GetComponent<Text>().text = "Kneel before me, human";
            End = true;
        }
        else
            Message.GetComponent<Text>().text = "Equals you and I, mmmh";
